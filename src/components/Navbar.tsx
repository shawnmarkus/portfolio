...
export default function Navbar({ resumeUrl }: NavbarProps): React.JSX.Element {
      ...
      >
        {NAV_LINKS.map((l, i) => (
          <a
            ...
            href={`#${l.toLowerCase()}`}
            onClick={closeMenu}
            className="font-sans font-bold text-4xl text-text-dim hover:text-amber transition-colors"
